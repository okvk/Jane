...
class ArticleFilterBackend(BaseFilterBackend):
    def get_schema_fields(self, view):
        return [
            ...
            coreapi.Field(name='is_published', location='query', required=False, type='string'), 
            coreapi.Field(name='keyword', location='query', required=False, type='string'), 
            coreapi.Field(name='scoped', location='query', required=False, type='string'), 
